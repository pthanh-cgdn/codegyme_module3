...
<a href="/students?action=create"><button class="btn btn-primary mt-4">Thêm</button></a>
...
<%--        <td>${student.id}</td>--%>
        ...
        <td>
            <c:choose>
                ...
                <c:when test="${student.mark >=6.5}">Hoc sinh kha</c:when>
                <c:when test="${student.mark >=5}">Hoc sinh trung binh</c:when>
